...
const ROLE_TOOL_GROUPS: Record<Role, ToolGroup[]> = {
  ...
  qa: ['init', 'task', 'bug', 'story', 'execution', 'comment', 'profile', 'statistics', 'relation', 'context', 'product', 'project', 'testcase', 'testtask', 'build', 'release', 'search', 'testcase-write', 'testtask-write'],
